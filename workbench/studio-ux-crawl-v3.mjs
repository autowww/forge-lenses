#!/usr/bin/env node
/**
 * Forge Lenses Studio UX crawl v3 — post FLS2 UX2 PDCA remediation.
 * Usage: node workbench/studio-ux-crawl-v3.mjs [baseUrl]
 * Output: workbench/studio-ux-crawl-v3/report.json
 */
...
const OUT_DIR = path.join(__dirname, 'studio-ux-crawl-v3')
