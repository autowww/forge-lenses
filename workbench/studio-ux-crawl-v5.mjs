 ...
 * Usage: node workbench/studio-ux-crawl-v5.mjs [baseUrl]
 * Output: workbench/studio-ux-crawl-v5/report.json
 */
...
const OUT_DIR = path.join(__dirname, 'studio-ux-crawl-v5')
