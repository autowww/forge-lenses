...
nav_title: 'Wizard 201: Repair stage'
public_publish: true
audience: public
product_area: wizard
tier: '201'
...
status: experimental
description: 'Wizard 201: Repair stage — Forge Lenses handbook entry (tutorials-201).'
page_type: tutorial
---
...
**Parent:** [Wizard 201 — Mission modes](10-wizard-201.md).
...
Do not use **Repair** for **new** discovery when no foundation exists — [Start from idea](10-wizard-201_01-start-from-idea.md) or [Assess current project](10-wizard-201_02-assess-current-project.md) fits better. If the blocker is purely tooling (server, save errors), fix the environment first ([Troubleshooting](12-troubleshooting.md)).
...
In [Wizard 101](09-wizard-101.md), steps **10–11** (**Review & generate**, **Recheck / repair**) are central here. You may still touch **Run plan** (step 9) to reorder work around fixes.
